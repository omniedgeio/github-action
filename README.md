...
1. [Sign up](https://connect.omniedge.io/register) your account
2. Generate Security-key, and get the Virtual Network ID from [Dashboard](https://connect.omniedge.io/dashboard)
